...
/*   Updated: 2022/04/29 13:54:37 by mhugueno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	program->climb_1.sprite = ft_new_sprite_climb_1(program->mlx,
			"./sprites/climb_1.xpm");
...
{
	program->climb_2.sprite = ft_new_sprite_climb_2(program->mlx,
			"./sprites/climb_2.xpm");
	mlx_put_image_to_window(program->mlx, program->window.reference,
...
{
	program->climb_3.sprite = ft_new_sprite_climb_3(program->mlx,
			"./sprites/climb_3.xpm");
	mlx_put_image_to_window(program->mlx, program->window.reference,
...
{
	program->climb_4.sprite = ft_new_sprite_climb_4(program->mlx,
			"./sprites/climb_4.xpm");
	mlx_put_image_to_window(program->mlx, program->window.reference,
