...
/*   Updated: 2022/04/29 13:57:38 by mhugueno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	program->climb_5.sprite = ft_new_sprite_climb_5(program->mlx,
			"./sprites/climb_5.xpm");
...
{
	program->climb_6.sprite = ft_new_sprite_climb_6(program->mlx,
			"./sprites/climb_6.xpm");
	mlx_put_image_to_window(program->mlx, program->window.reference,
